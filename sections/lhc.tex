...
Los planes a futuro del LHC preveen el \textit{Run 3} a 14 TeV, y luego ingresar en un nuevo período de inactividad para realizar las mejoras necesarias para el \textit{High Luminosity LHC}. \tosolve{Se puede agregar la típica imagen con los períodos.}

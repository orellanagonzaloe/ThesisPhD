...
% \solved{mejorar el inicio, mencionar iones pesados?} no hace falta
...
El detector interno está contenido dentro del solenoide superconductor, y mide \magn{6.2}{m} de largo y \magn{2.1}{m} de diámetro. El ID se compone de tres módulos que se describen a continuación, los cuales se esquematizan en las Figuras \ref{fig:pixel_1} y \ref{fig:pixel_23}.
...
solo parte de la componente hadrónica llega al HCAL. En la Figura \ref{fig:ecal} se observa un segmento del ECAL donde se muestra la granularidad de cada una de sus capas.
...
% Adicionalmente se puede aplicar una selección a los eventos de las \texttt{xAOD} para reducir aún más su tamaño. Esta selección produce el formato \textit{Derived Analysis Objetc Data} (DAOD), o simplemente derivación, y 

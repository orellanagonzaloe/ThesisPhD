...
En el marco de esta Tesis se emplearon un conjunto de SRs, las cuales pueden ser consideradas como experimentos de conteo independientes con distribuciones de Poisson, cuyas predicciones se obtienen a partir de simulaciones. \tosolve{data driven?} 

...
\tosolve{Mejorar imagen o al menos encontrar cita} 
}
...
% \tosolve{Duda sobre pi0} creo que ya esta resuelto...
...
% \tosolve{Duda sobre prompt} creo que ya esta resuelto...
...
% \tosolve{Algunas definiciones no son muy claras, tampoco en el paper...}
...
% \tosolve{Me gustaría poner algo de cuánto interactúan los muones con el detector, y algo de los muones cósmicos} Done!
...
% \tosolve{Agregar alguna referencia a análisis/definición de estas partículas} Done!
...
% \tosolve{No encuentro la definición de VarRad. FixedCutTight no aparece en el paper, sí en la twiki, raro...}

\chapter{Reconstrucción e identificación de objectos físicos}\label{cap:objects}
...
como $p$, $n$, piones y kaones. \tosolve{mecionar aca los taus} El diseño de los distintos subdetectores permite aprovechar las
...
% Fer: no definiste cluster
% GO: si, ya lo hice arriba

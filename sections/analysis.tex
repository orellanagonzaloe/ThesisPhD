...
% \tosolve{produciendo jets como parte de su decaimiento a neutralino sin carga de color} no entendi
...
Para los jets falseando fotones (\textit{jfakes}) se utilizó un método denominado \texttt{ABCD}, y para los electrones falseando fotones (\textit{efakes}) un método denominado \texttt{Tag\&Probe}. El modelado de todos los fondos se describe en las siguientes Secciones.
